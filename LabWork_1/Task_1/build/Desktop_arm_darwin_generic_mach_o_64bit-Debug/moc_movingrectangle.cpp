...
namespace {
struct qt_meta_tag_ZN15MovingRectangleE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN15MovingRectangleE = QtMocHelpers::stringData(
    "MovingRectangle",
    "move",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15MovingRectangleE[] = {
...
Q_CONSTINIT const QMetaObject MovingRectangle::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15MovingRectangleE.offsetsAndSizes,
    qt_meta_data_ZN15MovingRectangleE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15MovingRectangleE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<MovingRectangle *>(_o);
...
void *MovingRectangle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15MovingRectangleE.stringdata0))
